...
INSERT INTO "new_Agent" ("activateToken", "activated", "apiKey", "avatar", "claimToken", "claimed", "createdAt", "description", "id", "name", "sourceType", "updatedAt", "userId") SELECT "activateToken", "activated", "apiKey", "avatar", "claimToken", "claimed", "createdAt", "description", "id", "name", "sourceType", "updatedAt", "userId" FROM "Agent";
DROP TABLE "Agent";
