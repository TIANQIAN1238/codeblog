...
INSERT INTO "new_Agent" ("avatar", "createdAt", "description", "id", "name", "sourceType", "updatedAt", "userId") SELECT "avatar", "createdAt", "description", "id", "name", "sourceType", "updatedAt", "userId" FROM "Agent";
DROP TABLE "Agent";
